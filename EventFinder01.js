...
const newData1 = [
    ...
    {
      "title": "Food Festival",
      "description": "A culinary extravaganza featuring cuisines from around the world.",
      "date": "2024-12-20",
    ...
    },
    {
      ...
      "location": "Indore Business Center, Indore, India",
      "image": "11.jpeg"
    },
    {
      ...
      "location": "Art Gallery, Hyderabad, India",
      "image": "01.avif"
    },
    {
      "title": "Gardening Workshop",
      "description": "Tips and tricks for a beautiful garden.",
      "date": "2024-02-20",
      "time": "10:00 AM - 3:00 PM",
      "location": "Community Center, Indore, India",
      "image": "03.avif"
    },
    {
      "title": "Cultural Festival",
      "description": "Celebrate diverse cultures through dance, music, and food.",
      "date": "2024-01-14",
      "time": "12:00 PM - 10:00 PM",
      "location": "City Square, Pune, India",
      "image": "05.avif"
    },
    {
      "title": "Tech Workshop",
      ...
      "location": "Indore Tech Park, Indore, India",
      "image": "04.avif"
    },
    {
...
const myEventsData = [];
localStorage.setItem("newEvents",JSON.stringify(myEventsData));
...
function navBar(){
    ...
    navbar.setAttribute('style','margin:0; padding:1rem; align-items:center; justify-content:center; display:flex; flex-wrap:wrap;')
...
function eventsCard1(){
    eventsList = getData();
      ...
      eventsDiv.setAttribute('style','margin:0rem 5%; padding:1rem; padding-top:0; display:flex; flex-wrap:wrap;');
      const mainDiv = document.querySelector('#main');
    ...
    // card.addEventListener('click', () => eventDetails(anEvent));
  
      const cardImage = document.createElement('div');
      // const imageData = localStorage.getItem('eventsList[i].image');
      // image.src = imageData;
    ...
    //   cardFooter.addEventListener('click', () => eventDetails(anEvent));
...
function eventDetails(event){
    ...
    anEvent = event;
    // alert(anEvent);
    eventDetail.setAttribute('style','box-shadow: 1px 1px 20px red; border-radius:1rem; background:#f2f2f2; position: fixed; width:80%; height:70%; margin:2% 10%; display:flex; ');
    ...
    const cardImage = document.createElement('div');
      ...
      bookTicket.setAttribute('style','background:rgb(255,2,2,0.3); margin:4rem 3rem; margin-left:0; padding: 1rem; border-radius:1rem; box-shadow: 2px 2px 2px grey; cursor:pointer;');
...
function signUpPage(){
    ...
    logIn.setAttribute('style','box-shadow: 1px 1px 20px red; border-radius:1rem; background:#f2f2f2; position: fixed; width:70%; height:75%; margin:1% 15%; display:flex; ');
    logIn.id='signUpPage';
    const body = document.querySelector('#body');
    const mainDiv = document.querySelector('#main');
    ...
    password.setAttribute('style','border: 2px solid black; padding:7px; margin:1%; margin-left:25%; width:45%; border-radius:0.75rem;');
    password.placeholder='password';
    password.id='password';
    password.addEventListener('keyup',validatePassword);
    const passwordError = document.createElement('small');
    passwordError.id='passwordError';
    passwordError.setAttribute('style','color:red; padding:7px; margin:1%; margin-left:25%; width:45%;border-radius:0.75rem;');
    ...
    rightDiv.addEventListener('submit', (event) => {
        ...
        //   alert(1);
        if ( contactStaus && addressStatus && pincodeStatus && usernameStatus &&emailStatus && passwordStatus){
            profileSignUp();
            return true;
        }
...
function logInPage(){
    ...
    const h1 =document.createElement('h2');
    h1.innerText='Log In';
    h1.setAttribute('style','padding:5px; margin:5%; margin-left:25%; width:45%;');
    
    const email = document.createElement('input');
    email.setAttribute('style','border: 2px solid black; padding:7px; margin:2%; margin-left:25%; width:45%; border-radius:0.75rem;');
    email.placeholder='Email';
    email.id='email';
    email.addEventListener('keyup',validateEmail);
    const emailError = document.createElement('small');
    ...
    const password = document.createElement('input');
    password.type='password';
    password.setAttribute('style','border: 2px solid black; padding:7px; margin:2%; margin-left:25%; width:45%; border-radius:0.75rem;');
    password.placeholder='password';
    password.id='password';
    password.addEventListener('keyup',validatePassword);
    const passwordError = document.createElement('small');
    ...
    const pin = document.createElement('input');
    pin.setAttribute('style','border: 2px solid black; padding:7px; margin:2%; margin-left:25%; width:45%;border-radius:0.75rem;');
    pin.placeholder='pin-code';
    pin.id='pincode';
    pin.addEventListener('keyup',validatePincode);
    const pincodeError = document.createElement('small');
...
function homePage(){
    ...
    body.setAttribute('style','margin:0px;background-color:#f2f2f2;');
...
function createEvent(){
    ...
    createEventDiv.setAttribute('style','box-shadow: 1px 1px 20px red; border-radius:1rem; background:#f2f2f2; position: fixed; width:70%; height:70%; margin:2% 15%; display:flex; flex-wrap:wrap; ');
    ...
    addEvent.setAttribute('style','background:rgb(255,2,2,0.3); margin:2% 2%;  padding:0rem; border-radius:1rem; box-shadow: 2px 2px 2px grey; width:95%; cursor:pointer; align-items:center; justify-content:center; display:flex; font-weight:900; border:none;');
...
function footerComponent() {
    ...
    footerDiv.setAttribute(
      "style",
      "padding: 20px; background-color: #343a40; color: white; display: flex; justify-content: space-between; flex-wrap: nowrap; align-items: flex-start;"
    );
    ...
    firstGroup.setAttribute(
      "style",
      "display: flex; justify-content: space-between; width: 50%; flex-wrap: nowrap; padding-right: 20px; margin-right: 20px;"
    );
